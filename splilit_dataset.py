...
#test_size = 0.2
postfix = 'jpg'
imgpath = r'datasets\datasets_all\images'
txtpath = r'datasets\datasets_all\labels'

output_train_img_folder = r'datasets\datasets_all/datasets/images/train'
output_val_img_folder = r'datasets\datasets_all/datasets/images/val'
output_train_txt_folder = r'datasets\datasets_all/datasets/labels/train'
output_val_txt_folder = r'datasets\datasets_all/datasets/labels/val'
